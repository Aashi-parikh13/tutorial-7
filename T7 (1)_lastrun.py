...
expName = 'T7'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\AASHI\\Desktop\\AASHI CLG\\sem 5\\lab in psy\\tutorial 7\\T7 (1)_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('conditions (1).xlsx'),
